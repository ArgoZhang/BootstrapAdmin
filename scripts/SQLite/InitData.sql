...
INSERT INTO Users (UserName, Password, PassSalt, DisplayName, RegisterTime, ApprovedTime, ApprovedBy, [Description], [App]) values ('root', 'rjpzVoIlH3hOURVkoje+D3W/27QBkZLJGbZ16g5tp7A=', 'acnwsDUjA7ytKQJdINzyFkBY0maOmGTMq05ymWdtuanXmsoE', '超级用户', datetime(CURRENT_TIMESTAMP, 'localtime'), datetime(CURRENT_TIMESTAMP, 'localtime'), 'system', '系统默认创建', null);
